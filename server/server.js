...
mongoose.connect(MONGODB_URI||'mongodb://localhost/getTimer',{
...
//     time:'9:00',
//     title:'cloudOS',
//     description:'30 min study'
// }

// // save  by calling model 
// const getTimerTest = new getTimer(data);

// getTimerTest.save((error)=>{
//     if(error){
//         console.log('error');
//     }else{
